...
export type Error = ErrorAssertion | ErrorAssertionNotFound | ErrorBadParam | ErrorDecoding | ErrorEncoding | ErrorFileNotFound | ErrorIo | ErrorJson | ErrorManifest | ErrorManifestNotFound | ErrorNotSupported | ErrorOther | ErrorRawSigner | ErrorRemoteManifest | ErrorResourceNotFound | ErrorRwLock | ErrorSignature | ErrorVerify;
...
export type SigningAlgorithm = SigningAlgorithmPs256 | SigningAlgorithmPs384 | SigningAlgorithmPs512 | SigningAlgorithmEd25519 | SigningAlgorithmEs256 | SigningAlgorithmEs384;
...
export type RangeType = RangeTypeSpatial | RangeTypeTemporal | RangeTypeFrame | RangeTypeTextual | RangeTypeIdentified;
...
export type Role = RoleAreaOfInterest | RoleCropped | RoleEdited | RolePlaced | RoleRedacted | RoleSubjectArea | RoleDeleted | RoleStyled | RoleWatermarked;
...
export type Relationship = RelationshipParentOf | RelationshipComponentOf | RelationshipInputTo;
